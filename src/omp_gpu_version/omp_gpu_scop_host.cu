#include <assert.h>
#include <stdio.h>
#include "omp_gpu_scop_kernel.hu"
#include <stdio.h>
#include <stdlib.h>
#include <string.h>
#include <math.h>
...
int main( int argc, char* argv[] )
{
	...
	image_load( argv[1] );
	printf("++++++++++++++++++++++++++++++\n\tOpenMp + CUDA Version\t\n++++++++++++++++++++++++++++++\n");
	printf("time spent in CUDA code in %d iterations with OpenMp %d threads\n", ITERATION_NUM, THREAD_NUMBER);
	int i;
	...
	image_save( image_2, "output_omp_cuda.png" );

	printf("++++++++++++++++++++++++++++++++++++\n\tEnd of OpenMp + CUDA Version\t\n++++++++++++++++++++++++++++++++++++\n\n\n");
	return 0;
}
